...
window.EveModuleManifestParts.scripts = [
        ...
        'js/modules/features/bookmark-folders.shared.js?v=0.2.1',
        ...
        'js/modules/features/bookmark-folders.view.js?v=0.2.1',
        ...
        'js/modules/features/bookmark-folders.actions.js?v=0.2.1',
        ...
        'js/modules/features/bookmark-folders.js?v=0.3.0',
        ...
        'js/modules/features/constellation-map.js?v=0.4.0',
...
'js/modules/features/quick-pins.core.js?v=0.2.1',



'js/modules/features/quick-pins.js?v=0.3.0',
...
'js/modules/core/actions.js?v=0.2.3',
        ...
        'js/modules/features/data-state.capture.clone.js?v=0.2.2',
        ...
        'js/modules/features/data-state.capture.scoped.js?v=0.2.2',
        ...
        'js/modules/features/data-state.capture.js?v=0.2.2',
        ...
        'js/modules/features/data-state.apply.shared.js?v=0.2.2',
        ...
        'js/modules/features/data-state.apply.scoped.js?v=0.2.3',
        ...
        'js/modules/features/data-state.apply.js?v=0.2.1',
        ...
        'js/modules/features/data-transfer.shared.js?v=0.2.1',
        ...
        'js/modules/features/data-transfer.export.naming.js?v=0.2.1',
        ...
        'js/modules/features/data-transfer.export.library.js',
        ...
        'js/modules/features/data-transfer.export.utils.js',
        ...
        'js/modules/features/data-transfer.export.folder.writer.js?v=0.2.3',
        ...
        'js/modules/features/data-transfer.export.folder.backups.js?v=0.2.2',
        ...
        'js/modules/features/data-transfer.export.folder.paths.js',
        ...
        'js/modules/features/data-transfer.export.folder.js?v=0.2.1',
        ...
        'js/modules/features/data-transfer.export.js?v=0.2.2',
        ...
        'js/modules/features/data-transfer.folder-import.fs.js?v=0.2.1',
        ...
        'js/modules/features/data-transfer.folder-import.state.infer.js?v=0.2.1',
        ...
        'js/modules/features/data-transfer.folder-import.state.build.js?v=0.2.4',
        ...
        'js/modules/features/data-transfer.folder-import.state.js?v=0.2.1',
        ...
        'js/modules/features/data-transfer.folder-import.parse.handles.js?v=0.2.4',
        ...
        'js/modules/features/data-transfer.folder-import.parse.root.js?v=0.2.3',
        ...
        'js/modules/features/data-transfer.folder-import.parse.js?v=0.2.1',
        ...
        'js/modules/features/data-transfer.folder-import.activate.js?v=0.2.2',
        ...
        'js/modules/features/data-transfer.folder-import.restore.js?v=0.2.4',
        ...
        'js/modules/features/data-transfer.import-actions.js?v=0.2.1',
        ...
        'js/modules/features/modular-state-sync.engine.js?v=0.3.1',
        ...
        'js/modules/features/modular-state-sync.api.context.js?v=0.3.1',
...
'js/modules/modals/templates/tpl-bookmark-focus.js?v=0.2.3',
        ...
        'js/modules/modals/modal-category-settings.helpers.js?v=0.2.1',

        'js/modules/modals/modal-category-settings.js?v=0.3.0',
...
'js/modules/modals/logic/link-form.js?v=0.2.44',
        ...
        'js/modules/features/autotitle/autotitle-core.js?v=0.2.18',
