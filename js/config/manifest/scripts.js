...
window.EveModuleManifestParts.scripts = [
        ...
        'js/modules/features/constellation-map/constellation-map.shared.js?v=0.3.7',
        'js/modules/features/constellation-map/constellation-map.fx.base.js?v=0.1.1',
        ...
        'js/modules/features/constellation-map/constellation-map.fx.effects.webgl.quantum.js?v=0.2.0',
        'js/modules/features/constellation-map/constellation-map.fx.effects.webgl.shaders.js?v=0.1.0',
        'js/modules/features/constellation-map/constellation-map.fx.effects.canvas.ambient.js?v=0.1.0',
        'js/modules/features/constellation-map/constellation-map.fx.effects.canvas.interactive.js?v=0.1.0',
        'js/modules/features/constellation-map/constellation-map.fx.effects.canvas.waveforms.js?v=0.1.0',
        'js/modules/features/constellation-map/constellation-map.fx.effects.canvas.js?v=0.2.0',
        'js/modules/features/constellation-map/constellation-map.fx.effects.dom.js?v=0.1.0',
        ...
        'js/modules/features/constellation-map/constellation-map.render.auras.js?v=0.1.5',
        'js/modules/features/constellation-map/constellation-map.render.canvas.js?v=0.2.0',
        'js/modules/features/constellation-map/constellation-map.render.toolbar.js?v=0.1.2',
        ...
        'js/modules/features/constellation-map/constellation-map.toolbar.markup.js?v=0.1.4',
        'js/modules/features/constellation-map/constellation-map.toolbar.js?v=0.2.2',
