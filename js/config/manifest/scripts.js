...
window.EveModuleManifestParts.scripts = [
        ...
        'js/modules/features/data-state.apply.js',
        ...
        'js/modules/features/modular-state-sync.engine.js?v=0.3.0',
        'js/modules/features/modular-state-sync.api.js?v=0.3.0',
...
'js/modules/ui/dashboard/unidex-view.controls.state.js?v=0.2.1',
...
'js/modules/features/library/stats/stats-renderer.js?v=0.2.9',
        ...
        'js/modules/features/library/library-ui.panels.js',
...
'js/modules/features/library/library-bulk-auto.js?v=0.2.3',
        ...
        'js/modules/features/search-advanced/sa-ui.form.js',
