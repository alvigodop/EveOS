...
window.EveModuleManifestParts.scripts = [
        ...
        'js/modules/features/data-transfer.export.js?v=0.2.1',
        ...
        'js/modules/features/data-transfer.folder-import.restore.js?v=0.2.2',
...
'js/modules/features/library/stats/stats-renderer.js?v=0.2.9',
        ...
        'js/modules/modals/templates/tpl-settings.backup.js?v=0.2.6',
        ...
        'js/modules/modals/modal-settings.js?v=0.2.1',
