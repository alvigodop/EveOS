...
window.EveModuleManifestParts.scripts = [
        ...
        'js/modules/features/constellation-map/constellation-map.detached.js?v=0.1.1',
        ...
        'js/modules/features/constellation-map/constellation-map.render.inspector.js?v=0.1.3',
