...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/features/search-advanced/sa-index.js?v=0.4.0",
    ...
    "js/modules/features/search-advanced/sa-debug-view.js?v=0.1.4",
    ...
    "js/modules/features/search-advanced/sa-datapack-view.gateway.js?v=0.1.0",
