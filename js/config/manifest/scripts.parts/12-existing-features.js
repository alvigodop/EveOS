...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/features/search-advanced/sa-index.persistence.js?v=0.1.1",
    "js/modules/features/search-advanced/sa-index.js?v=0.3.9",
    ...
    "js/modules/features/search-advanced/sa-debug-view.js?v=0.1.3",
