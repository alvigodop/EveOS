...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/features/search-advanced/sa-nebula-json-link.js?v=0.1.0",
    "js/modules/features/search-advanced/sa-nebula-json-patch.js?v=0.1.0",
    ...
    "js/modules/features/search-advanced/sa-datapack-view.micro.js?v=0.1.1",
    "js/modules/features/search-advanced/sa-datapack-view.macro-actions.js?v=0.1.1",
    "js/modules/features/search-advanced/sa-datapack-view.js?v=0.1.1",
    ...
    "js/modules/features/search-advanced/sa-ui.results.vectors.parts.js?v=0.1.0",
