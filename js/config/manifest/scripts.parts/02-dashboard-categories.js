...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/ui/dashboard/categories/builder-card.render.progressive.js?v=0.1.1",
    "js/modules/ui/dashboard/categories/builder-card.render.summary.js?v=0.1.0",
    "js/modules/ui/dashboard/categories/builder-card.render.full.js?v=0.1.4",
    ...
    "js/modules/ui/dashboard/unidex-view.core.helpers.state.js?v=0.2.6",
