...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/ui/dashboard/unidex-view.builders.panels.js?v=0.2.2",
    "js/modules/ui/dashboard/unidex-view.builders.entries.js?v=0.2.6",
    ...
    "js/modules/ui/dashboard/unidex-view.stages.renderers.panels.js?v=0.2.5",
    ...
    "js/modules/ui/dashboard/unidex-view.core.js?v=0.2.49",
