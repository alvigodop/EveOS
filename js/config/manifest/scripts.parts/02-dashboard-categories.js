...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/ui/dashboard/categories/folder-view-v2.render.root.js?v=0.1.3",
    "js/modules/ui/dashboard/categories/folder-view-v2.render.navigation.js?v=0.1.5",
    ...
    "js/modules/ui/dashboard/categories/builder-card.folders.js?v=0.1.4",
    ...
    "js/modules/ui/dashboard/categories/builder-card.render.full.js?v=0.1.3",
    "js/modules/ui/dashboard/categories/builder-card.render.deferred.js?v=0.1.2",
    ...
    "js/modules/ui/dashboard/categories/render.js?v=0.2.48",
    ...
    "js/modules/ui/dashboard.js?v=0.2.57",
