...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/ui/dashboard/categories/builder-link.js?v=0.2.52",
    ...
    "js/modules/ui/dashboard/categories/builder-card.render.deferred.js?v=0.1.1",
    ...
    "js/modules/ui/dashboard.js?v=0.2.48",
