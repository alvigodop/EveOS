...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/ui/dashboard/unidex-view.controls.state.config.js?v=0.2.4",
    "js/modules/ui/dashboard/unidex-view.controls.state.transforms.js?v=0.2.2",
    "js/modules/ui/dashboard/unidex-view.controls.state.js?v=0.2.4",
    ...
    "js/modules/ui/dashboard/unidex-view.stages.renderers.panels.js?v=0.2.4",
    ...
    "js/modules/ui/dashboard/unidex-view.core.js?v=0.2.48",
