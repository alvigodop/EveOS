...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/ui/dashboard/categories/folder-view-v2.render.navigation.js?v=0.1.3",
    ...
    "js/modules/ui/dashboard/categories/builder-card.header.js?v=0.1.1",
    ...
    "js/modules/ui/dashboard/categories/builder-card.render.full.js?v=0.1.2",
    "js/modules/ui/dashboard/categories/builder-card.render.deferred.js?v=0.1.0",
    "js/modules/ui/dashboard/categories/builder-card.render.js?v=0.2.0",
    "js/modules/ui/dashboard/categories/builder-card.js?v=0.3.1",
    ...
    "js/modules/ui/bulk-toolbar.shared.js?v=0.2.6",
    "js/modules/ui/bulk-toolbar.templates.js?v=0.2.8",
    "js/modules/ui/bulk-toolbar.modals.category.js?v=0.2.3",
    "js/modules/ui/bulk-toolbar.modals.workspace.js?v=0.2.5",
    "js/modules/ui/bulk-toolbar.modals.merge.js?v=0.1.1",
    "js/modules/ui/bulk-toolbar.modals.js?v=0.2.4",
    "js/modules/ui/bulk-toolbar.js?v=0.2.8"
]);
