...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/ui/dashboard/categories/folder-view-v2.render.root.js?v=0.1.2",
    "js/modules/ui/dashboard/categories/folder-view-v2.render.navigation.js?v=0.1.4",
    ...
    "js/modules/ui/dashboard/categories/builder-card.folders.js?v=0.1.3",
