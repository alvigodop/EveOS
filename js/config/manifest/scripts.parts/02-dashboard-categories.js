...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/ui/dashboard/unidex-view.layout.js?v=0.2.12",
    "js/modules/ui/dashboard/unidex-view.stages.renderers.panels.js?v=0.2.9",
    ...
    "js/modules/ui/dashboard/unidex-view.core.helpers.state.js?v=0.2.5",
