...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/ui/dashboard/categories/folder-view-v2.render.navigation.js?v=0.1.6",
    ...
    "js/modules/ui/dashboard/categories/builder-card.render.routes.js?v=0.1.1",
    ...
    "js/modules/ui/dashboard/categories/render.helpers.js?v=0.1.1",
    "js/modules/ui/dashboard/categories/render.js?v=0.2.57",
    ...
    "js/modules/ui/dashboard.js?v=0.2.58",
