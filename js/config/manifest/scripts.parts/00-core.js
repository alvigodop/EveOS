...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/core/search-monitor-boot.trace.js?v=0.1.0",
    "js/modules/core/search-monitor-boot.js?v=0.2.2",
    ...
    "js/modules/features/edit-history/edit-history.capture.js?v=0.1.0",
    "js/modules/features/edit-history/edit-history.core.js?v=0.3.0",
    ...
    "js/modules/features/bookmark-merge-heuristics.js?v=0.1.4",
    "js/modules/features/bookmark-folders/bookmark-folders.shared.store.js?v=0.1.5",
    "js/modules/features/bookmark-folders/bookmark-folders.integrity.js?v=0.1.0",
    "js/modules/features/bookmark-folders/bookmark-folders.shared.library.js?v=0.1.1",
    ...
    "js/modules/features/bookmark-folders/smart-view-registry.shared.js?v=0.1.0",
    "js/modules/features/bookmark-folders/smart-view-registry.groups.js?v=0.1.1",
    "js/modules/features/bookmark-folders/smart-view-registry.store.js?v=0.1.0",
    "js/modules/features/bookmark-folders/smart-view-registry.records.js?v=0.1.0",
    "js/modules/features/bookmark-folders/smart-view-registry.builder.js?v=0.1.1",
    "js/modules/features/bookmark-folders/smart-view-registry.js?v=0.2.0",
    ...
    "js/modules/features/bookmark-folders/bookmark-folders.ghost-recursion.definitions.js?v=0.1.1",
    "js/modules/features/bookmark-folders/bookmark-folders.ghost-recursion.js?v=0.2.0",
    "js/modules/features/bookmark-folders/bookmark-folders.ghosts.js?v=0.3.0",
    "js/modules/features/bookmark-folders/bookmark-folders.view.js?v=0.2.3",
    ...
    "js/modules/features/constellation-map/constellation-map.detached.store.js?v=0.1.1",
    ...
    "js/modules/features/constellation-map/constellation-map.graph.projection.js?v=0.1.0",
    "js/modules/features/constellation-map/constellation-map.graph.js?v=0.2.8",
    ...
    "js/modules/features/constellation-map/constellation-map.render.inspector.core.js?v=0.1.1",
    ...
    "js/modules/features/constellation-map/constellation-map.core.actions.helpers.js?v=0.1.1",
    "js/modules/features/constellation-map/constellation-map.core.actions.create.js?v=0.1.1",
    ...
    "js/modules/features/constellation-map/constellation-map.core.actions.dispatch.js?v=0.1.1",
    ...
    "js/modules/features/chronos-engine.js?v=0.1.3",
    "js/modules/features/bookmark-click-behavior.js?v=0.2.4",
    "js/modules/features/bookmark-covers.js?v=0.2.7",
    "js/modules/features/quick-pins/quick-pins.core.base.js?v=0.1.0",
    "js/modules/features/quick-pins/quick-pins.core.store.js?v=0.1.1",
    ...
    "js/modules/features/dashboard-hydration-memory/dashboard-hydration-memory.markers.js?v=0.1.0",
    "js/modules/features/dashboard-hydration-memory/dashboard-hydration-memory.js?v=0.1.3",
    "js/modules/core/actions.js?v=0.2.11",
    ...
    "js/modules/ui/tab-nav-history.shared.js?v=0.2.0",
