...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/gemini/server_control/geminiServerNetwork.js?v=0.2.0",
    "js/modules/gemini/server_control/geminiCredentialBridge.js?v=0.2.0",
    "js/modules/gemini/server_control/geminiServerControl.js?v=0.2.3",
    "js/modules/gemini/server_control/geminiServerInspector.js?v=0.2.0",
    "js/modules/gemini/server_control/geminiCredentialWorkflow.js?v=0.1.0",
    "js/modules/gemini/Script_Loader/Script_Loader.js?v=0.2.5",
