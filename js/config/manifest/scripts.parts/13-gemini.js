...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/gemini/server_control/geminiServerControl.js?v=0.2.2",
    "js/modules/gemini/server_control/geminiServerInspector.js?v=0.1.0",
    "js/modules/gemini/server_control/geminiCredentialWorkflow.js?v=0.1.0",
    "js/modules/gemini/Script_Loader/Script_Loader.js?v=0.2.4",
