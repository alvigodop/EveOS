...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/modals/logic/link-form.library.notes.js?v=0.2.0",
    ...
    "js/modules/modals/modal-bookmark-focus.view.core.js?v=0.1.0",
    "js/modules/modals/modal-bookmark-focus.view.panels.js?v=0.1.0",
    ...
    "js/modules/modals/modal-bookmark-focus.audioflix.js?v=0.1.0",
    "js/modules/modals/modal-bookmark-focus.js?v=0.3.1",
    "js/modules/modals/logic/link-form.cover-images.js?v=0.1.0",
    "js/modules/modals/logic/link-form.related-urls.js?v=0.1.0",
    "js/modules/modals/logic/link-form.modal.js?v=0.1.6",
    "js/modules/modals/logic/link-form.js?v=0.3.0",
    "js/modules/modals/logic/category-rename.js?v=0.1.2",
