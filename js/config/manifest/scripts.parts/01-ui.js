...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/ui/sidebar.runtime.view-state.js?v=0.1.2",
    "js/modules/ui/sidebar.runtime.shared.js?v=0.1.3",
    "js/modules/ui/sidebar.runtime.interactions.js?v=0.1.0",
    "js/modules/ui/sidebar.runtime.groups.js?v=0.1.1",
    "js/modules/ui/sidebar.runtime.workspace.pointer-drag.js?v=0.1.3",
    "js/modules/ui/sidebar.runtime.workspace.item.js?v=0.1.3",
