...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/features/modular-state-sync/modular-state-sync.api.context.js?v=0.4.0",
    ...
    "js/modules/features/modular-state-sync/modular-state-sync.core.js?v=0.3.1",
