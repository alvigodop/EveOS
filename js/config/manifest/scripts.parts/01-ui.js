...
window.EveModuleManifestScriptChunks.push([
    ...
    "js/modules/features/data-state/data-state.apply.shared.js?v=0.2.3",
    "js/modules/features/data-state/data-state.apply.scoped.helpers.js?v=0.2.2",
    ...
    "js/modules/features/data-transfer/data-transfer.shared.restore.js?v=0.1.0",
    ...
    "js/modules/features/duplicate-sensor.merge.helpers.js?v=0.1.0",
