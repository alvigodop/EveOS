...
window.EveModuleManifestScriptChunks.push([
    // Modal Modules
    "js/modules/modals/templates/tpl-core.js?v=0.3.1",
    "js/modules/modals/templates/tpl-settings.backup.js?v=0.3.1",
    "js/modules/modals/templates/tpl-settings.js?v=0.3.1",
    ...
    "js/modules/modals/modal-settings.modular.ui.js?v=0.2.5",
    ...
    "js/modules/modals/modal-settings.js?v=0.3.0",
