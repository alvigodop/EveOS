    ...
    window.EveFolderViewV2.enterFolder = function (event, categoryName, folderId, workspaceId) {
        ...
        const folderHeaderActionsHtml = folderId
            ? `<div class="folder-breadcrumb-actions">`
                ...
                + `<button type="button" class="folder-tile-edit-btn folder-breadcrumb-icon-btn bulk-scope-btn" data-scope-category="${escapeCardJs(categoryName)}" data-scope-workspace="${escapeCardJs(workspaceId)}" data-scope-folder-id="${escapeCardJs(folderId)}" title="Select Folder Subtree" onclick="event.preventDefault(); event.stopPropagation(); bulkToggleFolderScopeSelection('${escapeCardJs(categoryName)}', '${escapeCardJs(workspaceId)}', '${escapeCardJs(folderId)}');">&#9744;</button>`
        ...
        const folderHeaderActionTrayHtml = (folderId && headerActionsExpanded)
            ? `<div class="folder-breadcrumb-action-tray">${editFolderButtonHtml}<button type="button" class="folder-breadcrumb-action-btn bulk-scope-btn" data-scope-category="${escapeCardJs(categoryName)}" data-scope-workspace="${escapeCardJs(workspaceId)}" data-scope-folder-id="${escapeCardJs(folderId)}" title="Select Folder Subtree" onclick="event.preventDefault(); event.stopPropagation(); bulkToggleFolderScopeSelection('${escapeCardJs(categoryName)}', '${escapeCardJs(workspaceId)}', '${escapeCardJs(folderId)}');">&#9744; Select Subtree</button><button type="button" class="folder-breadcrumb-action-btn" title="Auto-Title Links" onclick="event.preventDefault(); event.stopPropagation(); window.EveFolderViewV2.openFolderBulkTitle('${escapeCardJs(categoryName)}', '${escapeCardJs(folderId)}', '${escapeCardJs(workspaceId)}');">&#127991; Auto-Title</button><button type="button" class="folder-breadcrumb-action-btn" title="Auto-Add Library Entries" onclick="event.preventDefault(); event.stopPropagation(); window.EveFolderViewV2.openFolderBulkLibraryAuto('${escapeCardJs(categoryName)}', '${escapeCardJs(folderId)}', '${escapeCardJs(workspaceId)}');">&#128214; Auto-Library</button></div>`
            : '';
