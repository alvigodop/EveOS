            ...
            const summaryActionsHtml = (isGhostNode || readOnlyFolders || isDetachedParkingCard)
                ...
                : ''
                    + '<div class="bookmark-folder-summary-actions">'
                        ...
                        + `<button type="button" class="bookmark-folder-inline-btn bulk-scope-btn" data-scope-category="${safeCategoryJs}" data-scope-workspace="${safeWorkspaceJs}" data-scope-folder-id="${escapeCardJs(node.id)}" title="Select this folder subtree" onclick="event.preventDefault();event.stopPropagation();bulkToggleFolderScopeSelection('${safeCategoryJs}', '${safeWorkspaceJs}', '${escapeCardJs(node.id)}')">&#9744;</button>`
