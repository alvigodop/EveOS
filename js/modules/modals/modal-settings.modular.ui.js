...
function normalizeBackupSettingsMode(mode) {
    ...
    const allowed = ['all', 'full', 'group', 'workspace', 'card', 'folder', 'bookmark', 'audioflix', 'modular', 'layer'];
...
function applyBackupSettingsLayout(mode) {
    ...
    const visibleByMode = {
        all: ['full', 'group', 'workspace', 'card', 'folder', 'bookmark', 'audioflix', 'modular', 'layer'],
        full: ['full'],
        group: ['group'],
        workspace: ['workspace'],
        card: ['card'],
