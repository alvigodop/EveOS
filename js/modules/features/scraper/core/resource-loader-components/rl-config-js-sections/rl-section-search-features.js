...
(function () {
    ...
    window.ResourceLoaderJSSections.features = [
        ...
        'js/modules/wiki/fandom-domains/fandom-domains.js',
        'js/modules/wiki/wiki-entries/wiki-entries-components/we-fetcher.js',
        'js/modules/wiki/wiki-entries/wiki-entries.js',
        ...
        'js/modules/wiki/wiki-cache-manager/wiki-cache-manager.js',
        ...
        'js/modules/wiki/wiki-content-helper/wiki-content-helper.js',
