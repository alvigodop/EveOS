...
(function (ns) {
    ...
    function buildOverlayMarkup() {
        return [
            ...
            '</div>',
            '<div data-map-rewire-summary class="map-controls-summary">Drag or click a bookmark or folder to arm it, then drop or click a card or folder target. In Unidex or workspace scope, target another card to transfer chains across cards.</div>',
            '<div style="font-size:0.76rem;line-height:1.55;color:rgba(255,255,255,0.72);">',
            'Drag bookmark and folder nodes onto card or folder nodes to reattach them, or arm a node and click a valid target for fast reassignment. Drop on empty space to detach them to the card root. Use Unidex or workspace scope when you want to transfer chains across cards.',
            '</div>',
            '</div>',
            '</details>',
            '<details open class="map-controls-section">',
