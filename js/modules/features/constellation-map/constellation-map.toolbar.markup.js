...
(function (ns) {
    ...
    function buildOverlayMarkup() {
        return [
            ...
            '</div>',
            '</div>',
            '<div data-map-controls-panel style="display:none;flex-direction:column;gap:12px;align-items:stretch;align-self:stretch;min-width:min(520px,calc(100vw - 40px));max-width:min(62vw,1080px);padding:14px 16px;border:1px solid rgba(255,255,255,0.14);background:rgba(4,10,20,0.92);border-radius:16px;box-shadow:0 18px 34px rgba(0,0,0,0.28);">',
