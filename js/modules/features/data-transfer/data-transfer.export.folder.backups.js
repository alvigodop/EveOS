...
(function () {
    window.EveDataTransfer.ExportModules.createFolderBackupHelpers = function createFolderBackupHelpers(deps) {
        ...
        const folderBackupShared = window.EveDataTransfer.ExportModules.createFolderBackupSharedHelpers(deps, backupDirs);
        const { getZipHelpers, canUseZip, ensureZipReady, parseScopedCategoryKey, buildWorkspaceCardEntries, cleanupPartialFolder } = folderBackupShared;
