...
(function () {
    ...
    function injectStyles() {
        ...
        style.textContent = [
            ...
            ...(window.EveGeminiAskInsights?.styles || [])
        ].join('\n');
    ...
    function ensureAskPanel() {
        ...
        insightController = window.EveGeminiAskInsights?.attach?.(body) || null;
    ...
    function init() {
        ...
        window.EveGeminiAskBar = {
            ...
            refreshStreamPanel: function () { return insightController?.refreshStreamPanelState?.(); },
            openInsightViewer: function () { return insightController?.openInsightViewer?.(); }
        };
        return true;
    }
