...
const socketCoreScripts = [
    ...
    `${SOCKET_CORE_BASE_PATH}/audioPlayerUI.js?v=6554d5237b29`,
    `${SOCKET_CORE_BASE_PATH}/socketAudioLogic.js?v=9ecbb6a8461f`,
    `${SOCKET_CORE_BASE_PATH}/serverStatusChecker.js?v=acf5577ca034`
];
