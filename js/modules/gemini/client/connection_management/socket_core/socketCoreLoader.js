...
const socketCoreScripts = [
    ...
    `${SOCKET_CORE_BASE_PATH}/socketGlobalState.js?v=cbc22e4cb7fd`, // Load Global State before handlers
    ...
    `${SOCKET_CORE_BASE_PATH}/scc/eh/closeEventHandler.js?v=43799fba7e1c`,
    ...
    `${SOCKET_CORE_BASE_PATH}/socketMessageRouter.js?v=db0ed9924ac5`,
