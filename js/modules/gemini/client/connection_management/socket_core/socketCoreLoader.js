...
const socketCoreScripts = [
    ...
    `${SOCKET_CORE_BASE_PATH}/socketGlobalState.js?v=0.2.4`, // Load Global State before handlers
    `${SOCKET_CORE_BASE_PATH}/scc/eh/errorEventHandler.js?v=0.2.2`,
    `${SOCKET_CORE_BASE_PATH}/scc/eh/openEventHandler.js?v=0.2.0`,
    `${SOCKET_CORE_BASE_PATH}/scc/eh/closeEventHandler.js?v=0.2.9`,
    ...
    `${SOCKET_CORE_BASE_PATH}/serverStatusChecker.js?v=0.3.0`
];
