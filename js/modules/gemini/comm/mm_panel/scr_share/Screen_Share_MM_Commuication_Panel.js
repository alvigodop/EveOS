...
const screenShareScripts = [
    ...
    `${SCREEN_SHARE_BASE_PATH}/screen_capture_functions/captureSender.js`,
    `${SCREEN_SHARE_BASE_PATH}/screen_capture_functions/frameProcessor.js`,
    `${SCREEN_SHARE_BASE_PATH}/screen_capture_functions/captureStreamController.js`,
    `${SCREEN_SHARE_BASE_PATH}/screen_capture_functions/screenCapture.js`, // Handles UI interactions and communication
