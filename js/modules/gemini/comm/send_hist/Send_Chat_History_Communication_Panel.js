// js/modules/gemini/comm/send_hist/Send_Chat_History_Communication_Panel.js - Loads all JS for Send Chat History Communication Panel Features

console.log("js/modules/gemini/comm/send_hist/Send_Chat_History_Communication_Panel.js started loading");
...
const SEND_CHAT_HISTORY_BASE_PATH = (window.GEMINI_APP_ROOT || '') + 'js/modules/gemini/comm/send_hist';
...
console.log("js/modules/gemini/Communication_Panel/Send_Chat_History_Communication_Panel/Send_Chat_History_Communication_Panel.js finished loading and initial execution");
