...
const masterScriptList = [
    ...
    `${BASE_PATHS.CLIENT_CORE}/page_initialization/page_initialization_core/pageInitializerLoader.js?v=0.1.6`,
    ...
    // 2. Agentic Functions
    `${BASE_PATHS.AGENTIC}/audio_proc/audio_proc.js?v=0.1.4`,
    ...
    APP_ROOT + 'js/modules/gemini/mode2/textBrainRelay.js?v=0.1.5',
