const { installApiSearchFixtures } = require('./api_card_settings_browser_smoke.search.fixtures');

async function runApiSearchScenario(page) {
    return page.evaluate(async (installApiSearchFixturesSource) => {
        const installApiSearchFixturesInPage = new Function('return (' + installApiSearchFixturesSource + ')')();
        await installApiSearchFixturesInPage();
    ...
    }, installApiSearchFixtures.toString());
}
module.exports = {
