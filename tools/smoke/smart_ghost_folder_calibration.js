...
load('js/modules/features/bookmark-folders/bookmark-folders.shared.derived.normalize.js');
load('js/modules/features/bookmark-folders/bookmark-folders.shared.derived.metrics.js');
...
load('js/modules/features/bookmark-folders/bookmark-folders.management.mutations.basic.js');
load('js/modules/features/bookmark-folders/bookmark-folders.management.mutations.cross-scope.js');
load('js/modules/features/bookmark-folders/bookmark-folders.management.mutations.js');
load('js/modules/features/bookmark-folders/bookmark-folders.management.drop.actions.js');
