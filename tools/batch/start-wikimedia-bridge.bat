...
set "BRIDGE_PORT=%WIKIMEDIA_BRIDGE_PORT%"
if not defined BRIDGE_PORT set "BRIDGE_PORT=3039"
...
start "EveOS Wikimedia Bridge" cmd /k "cd /d ""%PROJECT_ROOT%"" && set ""EVEOS_PROJECT_ROOT=%PROJECT_ROOT%"" && set ""PYTHONUNBUFFERED=1"" && ""%EVEOS_PYTHON%"" -u ""%BRIDGE_SCRIPT%"" %BRIDGE_PORT%"
