            ...
            while self.connection_active:
                ...
                try:
                    ...
                    if inactive_time > 60:  # 1 minute
                        ...
                        if inactive_time > 90:  # 1.5 minutes - send a warning
                            system_msg = {
                                "is_system_message": True,
                                "text": "WARNING: Connection inactive for over 90 seconds. The connection may be closed soon if no activity is detected."
                            }
                            try:
